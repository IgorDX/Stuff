  ...
  cart.cartItems.length > 0 && <span className='absolute right-0 -bottom-[2px] h-3 w-3 rounded-full px-1 py-[1px] bg-categoriesPink text-white font-bold text-[9px] flex items-center justify-center'>{
    cart.cartItems.reduce((accumulator, cartItem) => {
        return accumulator + cartItem.quantity;
         ...
         <button className="mobile-nav-btn cursor-pointer" onClick={()=> setIsMobileNavOpen(prev=> !prev)}>
