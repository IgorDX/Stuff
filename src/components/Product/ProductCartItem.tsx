...
export const ProductCartItem: React.FC<ProductCartItemProps> = ({
  ...
  const { onDecreaseQuantity, onIncreaseQuantity, isRemoved, onRemoveFromCartDelayed } = useCart({ animationDelay: 300 });
  ...
  return (
    ...
    >
      <Link onClick={() => setIsDrawerOpen(false)} to={`/product/${id}`} className="flex items-center">
        <div
