...
export const useSignUpForm = (closeDrawer : ()=> void) => {
  ...
  const form = useForm<UserSignUpFormValues>({
    ...
    defaultValues: {
      name: '',
      email: '',
      avatar: "https://images.unsplash.com/photo-1529778873920-4da4926a72c2?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Y3V0ZSUyMGNhdHxlbnwwfHwwfHx8MA%3D%3D",
      password: '',
    },
  });
