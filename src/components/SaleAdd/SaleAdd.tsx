...
<div className='flex flex-col md:flex-row items-center justify-center rounded-md'>
    ...
    <div className="w-full md:w-1/2 h-auto xs:h-[450px] bg-customGray flex flex-col justify-between relative">
        ...
        <img className='scale-75 opacity-80 xs:opacity-100 xs:scale-100 absolute bottom-[70px] -left-20 z-10' src={imgLeftF} alt="Left Image" />
        <img className='scale-75 opacity-80 xs:opacity-100 xs:scale-100 absolute -bottom-[26px] right-0 z-10' src={imgLeftS} alt="Right Image" />
    </div>
