...
export const ProductFullImage : React.FC<ProductFullImageProps>= ({
  ...
  return (
    <div className={`fixed inset-0 transition-all duration-300 bg-heroGray bg-opacity-80 z-[300] visible ${isOpen ? '' : 'opacity-0 invisible -z-10'}`} onClick={()=> setProductFullImageOpen(false)}>
