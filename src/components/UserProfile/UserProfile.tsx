...
export const UserProfile = () => {
  ...
  return (
    <div className="bg-customGray p-5 rounded-md h-fit flex-1">
      <h3 className="text-white text-lg xs:text-2xl mb-5">Welcome to your profile {form.watch('name')}!</h3>
      <div className="flex flex-col  gap-5">
        <div className="relative">
          <img
            src={currentUser.avatar}
            className={`rounded-md w-full object-cover max-w-full h-full  ${isAvatarChanged ? 'opacity-60' : ''}`}
            alt=""
          />
          {isAvatarChanged && (
    ...
    />
            ...
            <FileInput title="Upload Avatar" setValue={form.setValue} register={form.register} name="avatar" />
          </div>
